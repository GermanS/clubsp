...
use_ok('ClubSpain::XML::Olympia::Response::Pictogram');

my @expect = map new ClubSpain::XML::Olympia::Pictogram($_),
...
my $result = ClubSpain::XML::Olympia::Response::Pictogram->parse($response);
