...
#ok
{
    ...
    is($msg->class, 'alert-success', 'got success class');
...
#info
{
    ...
    is($msg->class, 'alert-info', 'got info class');
...
#warning
{
    ...
    is($msg->class, 'alert-alert', 'got warning class');
...
#error
{
    ...
    is($msg->class, 'alert-error', 'got error class');
