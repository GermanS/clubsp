...
#pass id to the function
{
    ...
    is $timetable->is_published, 1
        => 'got is published flag';
    is $timetable->flight_id, 1
        => 'got flight id';
    is $timetable->airplane_id, 3
        => 'got airplane id';
    is $timetable->departure_date, '2011-02-12'
        => 'got departure date';
    is $timetable->departure_time, '10:00:00'
        => 'got departure time';
    is $timetable->arrival_date, '2011-02-12'
        => 'got arrival date';
    is $timetable->arrival_time, '16:00:00'
        => 'got arrival time';
    is $timetable->departure_terminal_id, undef
        => 'got departure terminal id';
    is $timetable->arrival_terminal_id, undef
...
#retrive
{
    ...
    is $object->flight_id, 1
        => 'got flight id';
    is $object->airplane_id, 3
        => 'got airplane id';
    is $object->departure_date, '2011-02-12'
        => 'got departure date';
    is $object->departure_time, '10:00:00'
        => 'got departure time';
    is $object->arrival_date, '2011-02-12'
        => 'got arrival date';
    is $object->arrival_time, '16:00:00'
        => 'got arrival time';
