...
is($result->departure_time, '01:01', 'got departure time');
is($result->arrival_date, '2012-01-01', 'got arrival date');
is($result->arrival_time, '02:02', 'got arrival time');
is($result->departure_terminal_id, undef, 'got terminal id');
