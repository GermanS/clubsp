...
<integracion accion="informe_imprenta" id_articulo="848" prestatario="49" nombre_articulo="14 noches">
        ...
        <suplementos>
                 <suplemento id_suplemento="1086" fecha_desde="2009-11-02" fecha_hasta="2010-03-22"
                 pvp="210.00" porcentaje="0.00" id_clase="2" nombre_clase="Extra pax" referencia_pb="1"
                 obligatorio="0" importe_por="pax" rango_fechas="total">Individual</suplemento>
                 <suplemento id_suplemento="1087" fecha_desde="2009-11-02" fecha_hasta="2010-03-22"
                 pvp="0.00" porcentaje="0.00" id_clase="4" nombre_clase="Varios" referencia_pb="1"
                 obligatorio="1" importe_por="articulo" rango_fechas="total">
                 BONIFICACION 100 EUROS POR PASAJERO
                 </suplemento>
                 <suplemento id_suplemento="1088" fecha_desde="2009-11-02" fecha_hasta="2010-03-22"
                 pvp="0.00" porcentaje="0.00" id_clase="2" nombre_clase="Extra pax" referencia_pb="1"
                 obligatorio="0" importe_por="pax" rango_fechas="total">Tercera persona</suplemento>
        </suplementos>
        <ofertas/>
        </rango>
</integracion>
